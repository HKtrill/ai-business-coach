...
----------------------------
    from glass_pipeline.lr import engineer_features          # feature engineering
    from glass_pipeline.lr import analyze_and_prune_features # correlation pruning
    from glass_pipeline.lr import train_lr_stage             # calibrated stage (production)
    from glass_pipeline.lr import train_baseline_lr_stage    # baseline stage (comparison)

    Import root is ``bank_pipeline/`` — see ``shared/__init__.py``.
...
-------------------------------------------------
    ...
    lr.artifacts       save_artifact, load_artifact
