# ============================================================
# GLASS ROUTER: RULE GENERATOR MODULE 
# ============================================================
...
from glass_pipeline.glass_router.core.rule import CandidateRule
...
class RuleGenerator:
    ...
    def _print_depth_summary(self, depth: int, stats: Dict[int, Dict]):
        ...
        for cls in (0, 1):
            ...
            print(f"\n{pass_name}:")
            print(f"  Total considered: {cls_stats.get('total_considered', 0)}")
            print(f"  Accepted: {cls_stats.get('accepted', 0)}")
