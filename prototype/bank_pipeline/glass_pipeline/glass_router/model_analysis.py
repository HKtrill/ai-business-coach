"""
glass_pipeline.glass_router.model_analysis
==========================================

Reporting and analysis helpers for fitted GLASS Router models.
...
def compute_glass_analysis_metrics(
    ...
    """
    Compute detailed GLASS Router test-set analysis metrics.

    Parameters
    ----------
    glass : fitted GLASS Router model
        Model containing pass1_rules and pass2_rules.
    test_out : dict
        Standard GLASS Router output dict with:
...
def print_glass_analysis_report(metrics: Dict[str, Any]) -> None:
    """
    Print detailed GLASS Router analysis report.
    """
    n_test = metrics["n_test"]
    total_positives = metrics["total_positives"]

    print("\n" + "=" * 80)
    print("📊 GLASS ROUTER PERFORMANCE METRICS")
    print("=" * 80)
