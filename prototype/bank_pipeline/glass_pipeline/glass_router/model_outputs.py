"""
glass_router.model_outputs
=======================

Helpers for constructing GLASS ROUTER prediction outputs and summary metrics.

These utilities sit between the fitted GLASS ROUTER model and artifact saving.
...
def build_glass_output(
    ...
    """
    Build standardized GLASS ROUTER prediction output.
...
def compute_glass_summary_metrics(
    ...
    """
    Compute final GLASS ROUTER summary metrics used by ModelSaver.print_final_summary.
    """
