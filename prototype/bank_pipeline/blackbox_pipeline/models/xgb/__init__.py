...
# Shared-protocol entry points (same shared.stage_runner base as the GLASS EBM)
# override the standalone implementations imported above.
from .shared_protocol import (  # noqa: E402,F811
    XGBEstimator,
    XGBSearchSpace,
    XGBStage3Config,
    train_xgb_stage,
