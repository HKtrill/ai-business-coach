...
triple that ``GlassRouterPipeline.predict`` and both RF routers emit, so the GLASS
...
Notes
-----
Denominator conventions, matching ``glass_pipeline.glass_router.rule_generator.rule_metrics``::
