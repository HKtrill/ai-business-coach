...
Follows the GLASSBRWConfig discipline: the notebook is the single source of
...
# Mirrors glass_brw.rf_training._normalize_params output shape so that
...
class RFRouterConfig:
    ...
    rf_params
        ...
        produced by ``glass_brw.rf_training._normalize_params``. Reuse
